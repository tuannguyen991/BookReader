...
import 'package:demo_book_reader/widgets/confirm_payment.dart';
...
class PaymentModal extends StatefulWidget {
  ...
  const PaymentModal(
      {Key? key, required this.package, this.endDate, this.isUsing = false})
      : super(key: key);
...
class _PaymentModalState extends State<PaymentModal> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${widget.endDate != null ? 'Gia hạn ' : 'Đăng ký '}gói đọc'),
      ),
      body: Container(
              ...
              onPressed: () async {
                ...
                if (amount < 1000 || amount > 1000000) {
                  ...
                  if (result != null) {
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context) => ConfirmPayment(amount: price.toInt(), zpToken: zpTransToken,)));
                  }
                }
              }),
      ),
