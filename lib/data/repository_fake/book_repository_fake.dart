...
const Map<String, List<BookModel>> recommendedBooksMap = {
  'tuan_nka': [
    BookModel(
      id: 'Pac4vgAACAAJ',
      title: 'Harry Potter and the Half-blood Prince',
...
const Map<String, BookModel> lastBookMap = {
  'tuan_nka': BookModel(
    id: '0Yo7PgAACAAJ',
    title: "Harry Potter and the Philosopher's Stone",
    description:
...
const Map<String, List<BookModel>> readBookMap = {
  'tuan_nka': [
    BookModel(
      id: '0Yo7PgAACAAJ',
      title: "Harry Potter and the Philosopher's Stone",
...
const Map<String, List<BookModel>> favoriteBookMap = {
  'tuan_nka': [
    BookModel(
      id: '0Yo7PgAACAAJ',
      title: "Harry Potter and the Philosopher's Stone",
...
class BookRepositoryFake implements BookRepository {
  ...
  @override
  Future<List<BookModel>> getBookByName({
    required String token,
