...
// // import 'package:demo_book_reader/models/album/album_model.dart';
// // import 'package:demo_book_reader/models/author_test/author_test_model.dart';
...
// //       imagaLinkRanking:
// //           'https://cdn3.iconfinder.com/data/icons/stars-5/512/gold_star-128.png',
// //       readingTime: 232123,
// //       readBooks: 2,
// //     ),
// //     UserModel(
...
// //       imagaLinkRanking:
// //           'https://cdn3.iconfinder.com/data/icons/stars-5/512/silver_star-128.png',
// //       readingTime: 231,
// //       readBooks: 2,
// //     ),
// //     UserModel(
...
// //       imagaLinkRanking:
// //           'https://cdn3.iconfinder.com/data/icons/stars-5/512/bronze_star-128.png',
// //       readingTime: 341,
// //       readBooks: 2,
// //     ),
// //   ];
...
// //   @override
// //   Future<String> loginTest({
// //     required String username,
// //     required String password,
// //   }) async {
// //     // final uri = Uri.parse('${Remote.url}/api/v1/authors');
// //     // uri.queryParameters = {};

// //     final uri = Uri.https(
// //       '442f-125-235-239-66.ap.ngrok.io',
// //       'api/v1/authors'
// //       ,
// //       {
// //         'MaxResultCount': '1'
...
// //       final List<AuthorTestModel> x = parsed
// //           .map<AuthorTestModel>((json) => AuthorTestModel.fromJson(json))
// //           .toList();

// //       return x.first.name;

// //       // return AlbumModel.fromJson(jsonDecode(response.body)).title + username;
// //     } else {
